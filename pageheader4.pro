...
UBUNTU_TRANSLATION_DOMAIN="pageheader4.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pageheader4/tests/autopilot/run
aptest.depends  = sub-pageheader4

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pageheader4/tests/unit
unittest.depends  = sub-pageheader4
